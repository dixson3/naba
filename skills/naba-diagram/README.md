...
Rendered technical diagram images (flowchart, architecture, network, database, and more) via the naba CLI. For editable d2 source, use the diagram-authoring skill instead.

## Usage

`/naba-diagram <prompt> [--type <t>] [--style <s>] [--complexity <level>]`
