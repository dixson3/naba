...
# NABA_CF_DISTRIBUTION (local .envrc + GitHub repo secret) — the Makefile reads it from there.
#
...
DOMAIN="${NABA_SITE_DOMAIN:?set NABA_SITE_DOMAIN (the bare site host, e.g. naba.ysapp.net) in .envrc or the GitHub repo secret}"
BUCKET="${DOMAIN}"
...
log "  .envrc:      export NABA_CF_DISTRIBUTION=${DIST_ID}"
log "  repo secret: gh secret set NABA_CF_DISTRIBUTION --body ${DIST_ID}"
log ""
