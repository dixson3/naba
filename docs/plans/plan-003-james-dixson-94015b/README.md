# plan-003-james-dixson-94015b

> Modernize naba Gemini model usage: replace dead default gemini-2.0-flash-exp-image-generation with GA gemini-3.1-flash-image, wire imageConfig (aspectRatio + imageSize), expose gemini-3-pro-image quality tier, reconcile docs/spec
