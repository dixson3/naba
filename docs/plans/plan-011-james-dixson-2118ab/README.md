# plan-011-james-dixson-2118ab

> Author genuine MCP-specific skill/resource guidance for naba (how to invoke the MCP tools generate_image/edit_image/etc.), replacing the current mcp/ render that just re-exposes CLI slash-command guidance; keep context minimal/lazy-loaded; correct web/ mcp docs to match
