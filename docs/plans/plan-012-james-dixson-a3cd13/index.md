...
# plan-012-james-dixson-a3cd13

> Address issues #16 (apply VOICE.md across remaining user-facing docs), #17 (curated CHANGELOG.md for release notes), #18 (whole-skill garbage collection in skills install/upgrade)
