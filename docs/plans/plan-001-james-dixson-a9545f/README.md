# plan-001-james-dixson-a9545f

> Modernize naba skill packaging: align to skill-authoring conventions, replace claude-plugin with install.{sh,py}, drift-check, and local-only beads with GitHub upstream
