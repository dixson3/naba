# plan-006-james-dixson-d333fd

> Build a Pelican static website for naba (dark terminal theme) published to naba.ysapp.net via AWS S3+CloudFront+ACM+Route53, with a human-facing /downloads/ artifact mirror + latest.json (GitHub Releases stays canonical for self-update), iterated locally first
